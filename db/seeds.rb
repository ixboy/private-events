...
Event.create!(
  [
    {event_name: 'First Event', description: 'The Best Fashoin Show in Town', venue: 'Kampala', event_date: '2021-06-27', user_id: 5},
    {event_name: 'Dev Conference', description: 'The Annual Ruby on Rails Conference', venue: 'Tokyo', event_date: '2021-07-27', user_id: 6},
    {event_name: 'PHP Past Conf', description: 'Why PHP is still the best', venue: 'Pakistan', event_date: '2021-01-27', user_id: 3},
    {event_name: 'Lisp Conference', description: 'The father of all Functional Programming', venue: 'USA', event_date: '2021-02-27', user_id: 4},
  ]
)
